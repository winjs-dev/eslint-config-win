...
async function main() {
  ...
  // 发布
  logStep('Publishing package to company mirror source...');

  const publishArgs = ['publish', '--access', 'public', '--registry', 'https://registry.npmjs.org/', '--no-git-checks'];
